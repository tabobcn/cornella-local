...
export const categories = [
  {
    ...
    subcategories: [
      { id: 101, name: "Albañil y reformas", icon: "Hammer", count: 0 },
      { id: 102, name: "Carpintero", icon: "TreePine", count: 0 },
      { id: 103, name: "Cerrajero", icon: "Key", count: 0 },
      { id: 104, name: "Climatización y calefacción", icon: "Snowflake", count: 0 },
      { id: 105, name: "Electricista", icon: "Zap", count: 0 },
      { id: 106, name: "Fontanero", icon: "Droplet", count: 0 },
      { id: 107, name: "Jardinería", icon: "Flower2", count: 0 },
      { id: 108, name: "Limpieza", icon: "Sparkles", count: 0 },
      { id: 109, name: "Mudanzas", icon: "Truck", count: 0 },
      { id: 110, name: "Pintor", icon: "Paintbrush", count: 0 },
      { id: 111, name: "Reparación de móviles y PC", icon: "Smartphone", count: 0 },
    ]
  },
  {
    id: 2,
    ...
    subcategories: [
      { id: 201, name: "Bodega y vinos", icon: "Wine", count: 0 },
      { id: 202, name: "Carnicería y charcutería", icon: "Beef", count: 0 },
      { id: 203, name: "Frutería", icon: "Apple", count: 0 },
      { id: 204, name: "Panadería", icon: "Croissant", count: 0 },
      { id: 205, name: "Pastelería", icon: "Cake", count: 0 },
      { id: 206, name: "Pescadería", icon: "Fish", count: 0 },
      { id: 207, name: "Supermercado", icon: "ShoppingCart", count: 0 },
  ...
  },
  {
    ...
    subcategories: [
      { id: 301, name: "Asiático", icon: "Utensils", count: 0 },
      { id: 302, name: "Bar y cafetería", icon: "Coffee", count: 2 },
      { id: 303, name: "Heladería y churrería", icon: "IceCream", count: 0 },
      { id: 304, name: "Hamburguesería", icon: "Sandwich", count: 0 },
      { id: 305, name: "Kebab", icon: "Utensils", count: 0 },
      { id: 306, name: "Pizzería", icon: "Pizza", count: 0 },
      { id: 307, name: "Restaurante", icon: "UtensilsCrossed", count: 0 },
      { id: 308, name: "Tapas", icon: "Wine", count: 0 },
    ]
  },
  {
    id: 4,
    ...
    subcategories: [
      { id: 401, name: "Arreglos y sastrería", icon: "Scissors", count: 0 },
      { id: 402, name: "Calzado", icon: "Footprints", count: 0 },
      { id: 403, name: "Deporte", icon: "Dumbbell", count: 0 },
      { id: 404, name: "Bolsos y accesorios", icon: "ShoppingBag", count: 0 },
      { id: 405, name: "Joyería y relojería", icon: "Gem", count: 0 },
      { id: 406, name: "Lencería", icon: "Heart", count: 0 },
      { id: 407, name: "Óptica", icon: "Eye", count: 0 },
      { id: 408, name: "Ropa", icon: "Shirt", count: 0 },
    ]
  },
  {
    id: 5,
    ...
    subcategories: [
      { id: 501, name: "Barbería", icon: "Scissors", count: 0 },
      { id: 502, name: "Depilación", icon: "Sparkles", count: 0 },
      { id: 503, name: "Estética", icon: "Flower", count: 0 },
      { id: 504, name: "Maquillaje", icon: "Paintbrush", count: 0 },
      { id: 505, name: "Masajes y spa", icon: "Heart", count: 0 },
      { id: 506, name: "Peluquería", icon: "Scissors", count: 0 },
      { id: 507, name: "Perfumería", icon: "Droplets", count: 0 },
      { id: 508, name: "Uñas", icon: "Hand", count: 0 },
    ]
  },
  {
    id: 6,
    ...
    subcategories: [
      { id: 601, name: "Farmacia", icon: "Pill", count: 0 },
      { id: 602, name: "Fisioterapia", icon: "Activity", count: 0 },
      { id: 603, name: "Odontología", icon: "Smile", count: 0 },
      { id: 604, name: "Podología", icon: "Footprints", count: 0 },
    ]
  },
  {
    id: 7,
    ...
    subcategories: [
      { id: 701, name: "Lavado", icon: "Droplets", count: 0 },
      { id: 702, name: "Neumáticos", icon: "Circle", count: 0 },
      { id: 703, name: "Taller", icon: "Wrench", count: 0 },
    ]
  },
  {
    id: 8,
    ...
    subcategories: [
      { id: 801, name: "Mercado del Centro", icon: "Store", count: 0 },
      { id: 802, name: "Mercado Marsans", icon: "Store", count: 0 },
      { id: 803, name: "Mercado de San Ildefonso", icon: "Store", count: 0 },
    ]
  },
];
