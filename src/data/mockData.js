  ...
  sections: [
    {
      ...
      icon: "FileText",
      content: "CornellaLocal es una plataforma personal sin ánimo de lucro creada por Carlos Taboada Valencia (NIF 46462083J) para conectar a vecinos de Cornellà de Llobregat con comercios locales. Permite descubrir negocios, ver ofertas, solicitar presupuestos y aplicar a ofertas de empleo locales. El uso de la plataforma supone la aceptación íntegra de estos términos junto con el Aviso Legal y la Política de Privacidad.",
      bullets: [
        "El acceso y uso son gratuitos.",
        "El responsable es persona física, no empresa, y opera como intermediario entre usuarios y comercios.",
    ...
    },
    {
      ...
      icon: "User",
      content: "Para acceder a algunas funcionalidades es necesario crear una cuenta. Al registrarte garantizas que la información que aportas es veraz y te comprometes a mantenerla actualizada.",
      bullets: [
        "Eres responsable de la confidencialidad de tu contraseña y de toda actividad realizada desde tu cuenta.",
        "Una persona solo puede tener una cuenta activa. Las cuentas son personales e intransferibles.",
        "Para registrarte debes ser mayor de 14 años (LO 3/2018, art. 7).",
        "Puedes cerrar tu cuenta en cualquier momento contactando con cornellalocal@gmail.com.",
      ],
    },
    {
      id: 3,
      ...
      icon: "Smartphone",
      content: "Te comprometes a usar la plataforma conforme a la ley, la buena fe y el respeto a otros usuarios y comercios. CornellaLocal puede suspender o eliminar cuentas que infrinjan estas normas, sin necesidad de aviso previo si la infracción es grave.",
      bullets: [
        "Prohibido publicar contenido ilegal, ofensivo, difamatorio, racista, discriminatorio o que incite al odio.",
        "Prohibido suplantar la identidad de otra persona, negocio o entidad.",
        "Prohibido el uso automatizado (bots, scraping) sin autorización expresa.",
        "Prohibido intentar comprometer la seguridad de la plataforma o acceder a datos de otros usuarios.",
        "Prohibido el spam y las comunicaciones no solicitadas a otros usuarios.",
      ],
    },
    {
      id: 4,
      title: "Negocios y verificación",
      icon: "Store",
      content: "Cualquier comercio local de Cornellà puede registrarse en la plataforma. Para publicar ofertas, empleos o recibir presupuestos, el negocio debe ser verificado mediante un documento que acredite la titularidad.",
      bullets: [
        "El alta de un negocio requiere CIF/NIF del comercio y documento acreditativo (alta de autónomo, recibo a nombre del negocio, factura, etc.). No solicitamos DNI/NIE personal del propietario.",
        "El propietario se compromete a publicar información veraz sobre su negocio (horarios, ubicación, ofertas, precios).",
        "CornellaLocal se reserva el derecho a rechazar o eliminar negocios que no cumplan los requisitos.",
        "Las ofertas publicadas deben respetarse en el local físico. La publicación de ofertas falsas o engañosas puede dar lugar a la baja del negocio.",
      ],
    },
    {
      id: 5,
      ...
      icon: "MessageSquare",
      content: "Los usuarios pueden publicar reseñas, comentarios, fotos en el perfil de su negocio y otros contenidos. Al publicar contenido en CornellaLocal, otorgas al titular de la plataforma una licencia gratuita, no exclusiva y limitada al ámbito territorial de la plataforma para mostrarlo dentro del servicio.",
      bullets: [
        "Solo puedes publicar contenido del que seas autor o cuyos derechos te pertenezcan.",
        "Las reseñas deben basarse en una experiencia real con el negocio. Las reseñas falsas pueden ser eliminadas.",
        "Para reseñar es necesario tener email verificado y al menos 30 días de antigüedad como usuario.",
        "Cada usuario puede publicar como máximo 1 reseña por negocio y 2 reseñas por semana.",
        "El usuario es responsable del contenido que publica. CornellaLocal no se responsabiliza de su veracidad.",
      ],
    },
    {
      id: 6,
      title: "Presupuestos y candidaturas",
      icon: "ClipboardList",
      content: "Las solicitudes de presupuesto y las candidaturas a empleo son comunicaciones entre el usuario y el comercio. CornellaLocal sólo facilita la conexión.",
      bullets: [
        "Los acuerdos comerciales (precios, plazos, condiciones) se establecen exclusivamente entre el usuario y el comercio.",
        "CornellaLocal no es parte del contrato y no garantiza el cumplimiento de los acuerdos.",
        "El número de teléfono del usuario sólo se comparte con el comercio cuando el usuario acepta una cotización.",
        "Cualquier reclamación derivada de la transacción debe dirigirse al comercio.",
      ],
    },
    {
      id: 7,
      ...
      icon: "AlertTriangle",
      content: "CornellaLocal actúa como intermediario tecnológico. El servicio se ofrece \"tal cual\" y aunque se hace lo razonable por mantenerlo disponible y seguro, no se garantiza la ausencia total de errores ni la disponibilidad ininterrumpida.",
      bullets: [
        "No se responsabiliza de las relaciones entre usuarios y comercios.",
        "No se responsabiliza de la veracidad del contenido publicado por terceros.",
        "No se responsabiliza de daños derivados del uso indebido del servicio o de causas ajenas razonables (mantenimiento, fuerza mayor, fallos de proveedores externos).",
        "Se aplica la limitación de responsabilidad permitida por la legislación aplicable. Nada en estos términos limita derechos irrenunciables del consumidor.",
      ],
    },
    {
      id: 8,
      ...
      icon: "Copyright",
      content: "El nombre, logotipo, diseño y código de CornellaLocal son propiedad del titular o de sus proveedores. El contenido de los negocios (logos, fotos, marcas) es propiedad de cada negocio.",
      bullets: [
        "No se permite la reproducción, distribución o transformación de los contenidos sin autorización.",
        "Las marcas, nombres comerciales y logos visibles en la plataforma son propiedad de sus respectivos titulares.",
      ],
    },
    {
      id: 9,
      ...
      icon: "X",
      content: "CornellaLocal se reserva el derecho a suspender o cerrar cuentas que incumplan estos términos.",
      bullets: [
        "Se notificará al usuario salvo en casos de incumplimiento grave (fraude, contenidos ilegales, abuso del sistema).",
        "Las cuentas suspendidas pueden apelar escribiendo a cornellalocal@gmail.com.",
        "El usuario también puede solicitar el cierre de su cuenta en cualquier momento.",
      ],
    },
    {
      id: 10,
      ...
      icon: "RefreshCw",
      content: "Estos términos pueden actualizarse para reflejar cambios en el servicio o en la legislación. La fecha de la última actualización se muestra al inicio.",
      bullets: [
        "Los cambios entran en vigor desde su publicación.",
        "Si los cambios son sustanciales, se informará a los usuarios mediante notificación o email.",
        "El uso continuado tras una modificación se considera aceptación de los nuevos términos.",
      ],
    },
    {
      id: 11,
      ...
      bullets: [
        "Para usuarios consumidores, será competente el Juzgado del domicilio del usuario (art. 90.2 TRLGDCU).",
        "Para usuarios no consumidores, los Juzgados y Tribunales de Cornellà de Llobregat / Barcelona.",
        "Antes de acudir a la vía judicial, las partes intentarán resolver los conflictos de buena fe escribiendo a cornellalocal@gmail.com.",
      ],
    },
    {
      id: 12,
      title: "Contacto",
      icon: "Mail",
      content: "Para cualquier duda sobre estos términos:",
      bullets: [
        "Email: cornellalocal@gmail.com",
        "Responsable: Carlos Taboada Valencia (NIF 46462083J), Cornellà de Llobregat",
      ],
    },
  ],
};
